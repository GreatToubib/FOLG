function alpha=wolfeB(x,y,d,alpha0,Ytrain, Xtrain)
    % Entrees :
    ...
    alpha  = alpha0;
    while 1
        if w1B(x,y,d,alpha,beta1,Ytrain, Xtrain)==true && w2B(x,y,d,alpha,beta2,Ytrain, Xtrain)==true
            break;
        end
        if w1B(x,y, d,alpha,beta1,Ytrain, Xtrain)==false
        ...
        elseif w2B(x,y,d,alpha,beta2,Ytrain, Xtrain)==false
